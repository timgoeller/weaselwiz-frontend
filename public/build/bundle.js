...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(textarea, "input", handleCodeInput, false, false, false);
    				mounted = true;
    			}
    		},
    		p: noop,
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ foo, handleCodeInput });
    ...
    function create_fragment$1(ctx) {
    	...
    	let div2;
    	let current;
    	codeview = new Codeview({ $$inline: true });
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "svelte-1ywhwbn");
    			add_location(div0, file$1, 7, 1, 119);
    			attr_dev(div1, "id", "environment-view");
    			attr_dev(div1, "class", "svelte-1ywhwbn");
    			add_location(div1, file$1, 10, 1, 176);
    			attr_dev(div2, "id", "some-view");
    			attr_dev(div2, "class", "svelte-1ywhwbn");
    			add_location(div2, file$1, 11, 1, 212);
    			attr_dev(main, "id", "layout");
    			attr_dev(main, "class", "svelte-1ywhwbn");
    			add_location(main, file$1, 6, 0, 98);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			mount_component(codeview, div0, null);
    			append_dev(main, t0);
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Codeview, name });
